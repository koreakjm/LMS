   ...
   <div class="container">
      ...
      <div>
         ...
         <table class="table table-hover">
            ...
            현재시간 <fmt:formatDate pattern="YYYY-MM-dd HH:mm" value="${applyTime}"/>
            </span>
                  <!-- <button type="submit" class="btn btn-grad" onclick="button1_click();">참여</button> -->
                  
                  <button id="button1" class="btn btn-grad" onclick="apply();">참여</button>
